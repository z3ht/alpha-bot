...
/**
 * The carsData's orientation in space, a.k.a. what direction it's pointing.
 *
...
public class CarOrientation {
    ...
    /**
     * The direction that the front of the carsData is facing
     */
    public final Vector3 noseVector;

    /** The direction the roof of the carsData is facing. (0, 0, 1) means the carsData is upright. */
    public final Vector3 roofVector;

    /** The direction that the right side of the carsData is facing. */
