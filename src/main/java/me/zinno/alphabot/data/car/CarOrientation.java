...
/**
 * The carData's orientation in space, a.k.a. what direction it's pointing.
 *
...
public class CarOrientation {
    ...
    /** The direction that the front of the carData is facing */
    public final Vector3 noseVector;

    /** The direction the roof of the carData is facing. (0, 0, 1) means the carData is upright. */
    public final Vector3 roofVector;

    /** The direction that the right side of the carData is facing. */
